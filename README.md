                ...
                <div id="contents-page" class="vehicle-page">
                    <div class="">
                        ...
                        <div class="top-state clr">
                            ...
                            <div class="time">
                                <span id="date-display">2025/07/04</span>
                                <span id="time-display">09:57</span>
                                <span>기준</span>
                                <button class="btn btn04" id="date-time-refresh">새로고침</button>
                            </div>
                        </div>
                        <!--/ 상단 상태값 -->
                            ...
                            <script>
                                $(document).ready(function () {
                                    function getKoreanTime() {
                                        ...
                                        $("#date-display").html(`${year}/${month}/${day}`);
                                        $("#time-display").html(`${hour}:${minute}`);

                                      //  return `${year}/${month}/${day}  ${hour}:${minute}`;
                                    }
                                    getKoreanTime(); // Call the function to set the initial time
                                    ...
                                    data.forEach((item, index) => {
                                        ...
                                        const $tbody = $(`
                                            <tbody>
                                                <tr>
                                                    <td><input type="checkbox" id="depot-check-box" /></td>
                                    ...
                                    $('#depot-check-box').on('change', function () {
                                        if (this.checked) {
                                            console.log('✅ Checkbox is checked - showing series');

                                        } else {
                                            console.log('❌ Checkbox is unchecked - hiding series');
                                    ...
                                    $("date-time-refresh").on("click", function () {
                                        //getKoreanTime();
